...
| [Voice-Based Authentication](https://github.com/Shreya-Macherla/Voice-based-Authentication) | GMM speaker identification from MFCC features · **84.2% accuracy / 14.4% EER** on reproducible 40-speaker LibriSpeech benchmark · UKRI TRAITPASS programme | Real: LibriSpeech dev-clean benchmark + live microphone enrolment | Python · scikit-learn · SciPy |

> All remaining projects — [A/B Testing](https://github.com/Shreya-Macherla/AB-Testing-Statistical-Analysis) · [Online Retail RFM](https://github.com/Shreya-Macherla/Online-Retail-Predictions) · [Human Activity Recognition](https://github.com/Shreya-Macherla/Human-Activity-Recognition-using-CNN-and-RNN) · [Geospatial Analysis](https://github.com/Shreya-Macherla/Geospatial-Analysis) · [Concrete Slump](https://github.com/Shreya-Macherla/Simulation-of-Concrete-Slump-Prediction-Model-using-Data-Science-Techniques) · [Tweet Summarisation](https://github.com/Shreya-Macherla/Real-Time-Summarization-of-Twitter-Stream-Data)
